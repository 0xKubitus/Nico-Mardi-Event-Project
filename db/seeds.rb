...
### Generate 5 users
["",1,2,3,4,5].each do |i|
  User.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, description: "Cet utilisateur a la description suivante: Generated description ##{Faker::Number.number(digits: 5)}", email: "nico-events-project#{i}@yopmail.com")
end
